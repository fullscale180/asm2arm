...
function New-VmResource 
{
	...
	$vmStorageProfile = New-VmStorageProfile -DiskAction $DiskAction -VM $VM -StorageAccountName $storageAccountName -ImageName $VM.VM.OSVirtualHardDisk.SourceImageName -Location $location
