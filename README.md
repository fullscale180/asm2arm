...
2. Run Add-AzureAccount to connect to your Service Management subscription, and Login-LoginAzureRmAccount
3. Make sure default subscriptions are selected using Select-AzureSubscription for ASM and Select-AzureRmSubscription for ARM
4. Either bring in a VM with Get-AzureVm, or directly use ServiceName & Name combination to give the VM to the Add-AzureSMVmToRM cmdlet. 
